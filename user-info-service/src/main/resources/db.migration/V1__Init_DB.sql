...
create table users (id bigint not null,
                    ...
                    is_allowed_to_store_response_to_my_reviews boolean,
                    is_allowed_to_send_discounts_and_promotions_mailing_lists boolean,
                    is_allowed_to_send_popular_articles boolean,
